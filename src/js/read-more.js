$('#showr1').click(function () {
  ...
  $('.reviews__fake-hide').show('slow');
  $('.reviews__fake-read').hide('slow');
});

$('#hidr1').click(function () {
  $('.reviews__fake-text').hide('fast');
  $('.reviews__dots').show('slow');
  $('.reviews__fake-read').show('slow');
  $('.reviews__fake-hide').hide('slow');
});
